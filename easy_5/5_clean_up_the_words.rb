...
# 1. write a method that returns that string with all of the non-alphabetic characters replaced by spaces. 
# 2. the result should never have consecutive spaces
