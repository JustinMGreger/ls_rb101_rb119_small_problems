...
def halvsies(array_one)
  ...
  if array_one is odd
     ...
     first_half_array = [middle_element] should be placed in the first half Array and the second half array contains the rest of elements and these are a pair of nested Arrays.
